...
function insertNewItem(data) {
  return new Promise((resolve, reject) => {
    pool.query('INSERT INTO items SET ?', data, (err, insertItem, fields) => {
      if (err) { reject(err); return };
      resolve(insertItem);
    })
  })
...
function getHotBoardList() {
  return new Promise((resolve, reject) => {
    ...
    // let data = [];
    pool.query(string, (err, hotCountsResult, fileds) => {
      if (err) { reject(err); return };
...
function getConfirmedMatchItemsData(idArr) {
  return new Promise((resolve, reject) => {
    ...
    pool.query(string, [idArr], (err, getConfirmedMatchItemsDataResult, fileds) => {
      if (err) { reject(err); return };
...
function getItemDataByIdArr(idArr) {
  return new Promise((resolve, reject) => {
    ...
    pool.query(string, [idArr], (err, getItemResultArr, fields) => {
      if (err) { reject(err); return };
...
function getConfirmedMatches(token) {
  return new Promise((resolve, reject) => {
    ...
    pool.query(string, [token], (err, result, fileds) => {
      if (err) { reject(err); return };
      resolve(result);
    });
  })
...
function discontinueItem(id_Arr, insertedMatchId, con) {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (insertedMatchId) {
      ...
      pool.query(string, [id_Arr], (err, result, fileds) => {
        if (err) { reject(err); return };
